...
export function BankAccount() {
  ...
  const plan = useMemo(() => optimizePortfolio(BANKS, profile), [profile]);
  ...
  return (
    <div className="app">
      <header className="app-header">
        ...
        <p>
          Enter your balance and monthly activities. We recommend how to split
          savings and card spend across Singapore bank products to maximise
          interest.
        </p>
      </header>
